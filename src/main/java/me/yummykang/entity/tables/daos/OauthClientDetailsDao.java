...
@Repository
public class OauthClientDetailsDao extends DAOImpl<OauthClientDetailsRecord, me.yummykang.entity.tables.pojos.OauthClientDetails, String> {

    /**
     * Create a new OauthClientDetailsDao without any configuration
     */
    public OauthClientDetailsDao() {
        super(OauthClientDetails.OAUTH_CLIENT_DETAILS, me.yummykang.entity.tables.pojos.OauthClientDetails.class);
    }
    ...
    public OauthClientDetailsDao(Configuration configuration) {
        super(OauthClientDetails.OAUTH_CLIENT_DETAILS, me.yummykang.entity.tables.pojos.OauthClientDetails.class, configuration);
    }
     ...
     */
    @Override
    protected String getId(me.yummykang.entity.tables.pojos.OauthClientDetails object) {
     ...
     */
    public List<me.yummykang.entity.tables.pojos.OauthClientDetails> fetchByClientId(String... values) {
     ...
     */
    public me.yummykang.entity.tables.pojos.OauthClientDetails fetchOneByClientId(String value) {
     ...
     */
    public List<me.yummykang.entity.tables.pojos.OauthClientDetails> fetchByResourceIds(String... values) {
     ...
     */
    public List<me.yummykang.entity.tables.pojos.OauthClientDetails> fetchByClientSecret(String... values) {
     ...
     */
    public List<me.yummykang.entity.tables.pojos.OauthClientDetails> fetchByScope(String... values) {
     ...
     */
    public List<me.yummykang.entity.tables.pojos.OauthClientDetails> fetchByAuthorizedGrantTypes(String... values) {
     ...
     */
    public List<me.yummykang.entity.tables.pojos.OauthClientDetails> fetchByWebServerRedirectUri(String... values) {
     ...
     */
    public List<me.yummykang.entity.tables.pojos.OauthClientDetails> fetchByAuthorities(String... values) {
     ...
     */
    public List<me.yummykang.entity.tables.pojos.OauthClientDetails> fetchByAccessTokenValidity(Integer... values) {
     ...
     */
    public List<me.yummykang.entity.tables.pojos.OauthClientDetails> fetchByRefreshTokenValidity(Integer... values) {
     ...
     */
    public List<me.yummykang.entity.tables.pojos.OauthClientDetails> fetchByAdditionalInformation(String... values) {
     ...
     */
    public List<me.yummykang.entity.tables.pojos.OauthClientDetails> fetchByAutoapprove(String... values) {
